...
CREATE TABLE ALLOGGIO (
	...
	TIPO  enum ('Recinto basso', 'Recinto alto', 'Vasca', 'Teca', 'Prato', 'Acquario') NOT NULL,
...
CREATE TABLE ANIMALE (
	...
	HABITAT enum('Oceano','Calotta polare','Lago','Tundra','Taiga','Foresta','Prateria','Foresta pluviale','Macchia mediterranea','Giungla','Deserto','Steppa','Savana','Foresta subtropicale','Vegetazione alpina'),
	PESO INT UNSIGNED,
	ETA INT UNSIGNED, 	
	SESSO ENUM('M', 'F'),
	last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE MEDICINA(
    ...
    QUANTITA SMALLINT UNSIGNED DEFAULT 0,
last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,	
	PRIMARY KEY(ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;	
